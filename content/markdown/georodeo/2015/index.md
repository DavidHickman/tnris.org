...
<img class="img-circle pull-right presenter" src="{{m.link('static/images/georodeo/presenters/johanne_kabek.jpg')}}">
...
<h4><img class="img-circle pull-right presenter" src="{{m.link('static/images/georodeo/presenters/nik_freeman.jpg')}}" alt="Headshot of Nik Freeman">How to help a map go viral</h4>
...
<h4><img class="img-circle pull-right presenter" src="{{m.link('static/images/georodeo/presenters/gretchen_peterson.jpg')}}">Cartography in the Modern World</h4>
...
### Andrew Thornton
<h4><img class="img-circle pull-right presenter" src="{{m.link('static/images/georodeo/presenters/andrew_thornton.jpg')}}" alt="Headshot of Andrew Thornton">Web Maps with D3.js</h4>
