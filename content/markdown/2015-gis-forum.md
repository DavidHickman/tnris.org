...
<div class="well well-md personalize-agenda">
  ...
  <div class="checkbox">
    <label>
      <input type="checkbox" class="show-starred-check"> Show Only My Starred Presentations
    </label>
  </div>
</div>
        ...
        <div id="one-A-1600-c" class="agenda-track-item media">
          ...
          <div class="media-body">
            <h4 class="media-heading">
              ...
              Hosting Spatial Web Services in Support of Oil &amp; Gas Analytics: ArcGIS  Server, WMS &amp; WFS Cross-Platform Compatibility
            </h4>
