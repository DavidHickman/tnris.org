...
angular.module('dataDownloadApp')
  .directive('downloadMap', ['$compile', '$http', '$state', 'PARTIALS_PATH', 'BING_API_KEY', 'MapService', 'CartoService', function ($compile, $http, $state, PARTIALS_PATH, BING_API_KEY, MapService, CartoService) {
    'use strict';
